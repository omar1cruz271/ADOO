    ...
    <main class="page gallery-page">
        <section class="clean-block clean-gallery dark">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="<?php base_url(); ?>enviarPostales"><img  class="img-thumbnail img-fluid image" id="img1" src="assets/imgfactureras/aeromexico.jpg"  ></a></div>
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/factureras/volkswagen.jpg"><img class="img-thumbnail img-fluid image" src="assets/img/factureras/volkswagen.jpg"></a></div>
                    ...
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/ibm.jpg"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/ibm.jpg"></a></div>
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/scenery/google.jpg"><img class="img-thumbnail img-fluid image" src="assets/img/scenery/google.jpg"></a></div>
